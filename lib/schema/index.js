...
<<<<<<< HEAD
// QUERIES TABLE (previously "posts")
export const posts = pgTable("queries", {
  postId: varchar("query_id", { length: 50 }).primaryKey(),   // FIXED
=======
// queries (QUESTIONS)
export const queries = pgTable("queries", {
  queryId: varchar("query_id", { length: 50 }).primaryKey(),
>>>>>>> c2c038573166ed55545abdeb8af2943e07565516
...
export const answers = pgTable("answers", {
  ...
  postId: varchar("query_id", { length: 50 })   // FIXED FK COLUMN NAME
=======
