...
export const categories = pgTable("categories", {
  categoryId: varchar("category_id").primaryKey().default(sql`gen_random_uuid()`),
...
export const experts = pgTable("experts", {
  ...
  categoryId: varchar("category_id")
    .notNull()
    .references(() => categories.categoryId,{ onDelete: "cascade" }),//categoryId=>categoryId and cascade added 
